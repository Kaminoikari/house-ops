...
`house-ops` is an AI-powered house hunting pipeline for the Taiwan real estate market, built on Claude Code. It automates discovery, evaluation, and tracking of rental and purchase listings across major Taiwan platforms (591, 樂屋, 信義, 永慶, 東森, 住商, 實價登錄).
...
- **Repo:** Independent (`house-ops`), not part of career-ops
